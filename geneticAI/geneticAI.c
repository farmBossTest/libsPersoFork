...
int averageEntities(entity_t dest /*pas besoin de le passé par addresse car tout les champs modifier sont des tableaux*/, entity_t src1, entity_t src2){                  // les reseaux de neurones de dest, src1 et src2 doivent avoir la meme taille
